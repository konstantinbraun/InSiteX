...
{
    public partial class DialogsToolTip : System.Web.UI.UserControl
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            HiddenField hf = (HiddenField)DialogToolTip.FindControl("ResourceID");
            if (hf != null && hf.Value != null && !hf.Value.Equals(string.Empty))
            {
                ((Label)DialogToolTip.FindControl("NameVisible")).Text = (String)GetGlobalResourceObject("Resource", hf.Value);
            }
        }
    }
}