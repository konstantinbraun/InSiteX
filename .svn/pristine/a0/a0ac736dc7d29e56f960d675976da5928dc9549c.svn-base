...
namespace InsiteServices
{
    ...
    public partial class GetCompaniesData_Result
    {
        ...
        public Nullable<int> ParentIDReal { get; set; }
        public string ParentNameVisible { get; set; }
        public string ParentNameAdditional { get; set; }
