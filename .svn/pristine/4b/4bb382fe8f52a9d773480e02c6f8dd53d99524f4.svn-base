CREATE PROCEDURE [dbo].[AccessDataConsistency]
(
	@SystemID int,
	@BpID int,
	@PresenceDay date
...
-- Tagesende des Anwesenheitstages als Datum / Uhrzeit ermitteln
DECLARE @EndOfDay datetime = DATEADD(DAY, 1, @PresenceDay);
SET @EndOfDay = DATEADD(SECOND, -1, @EndOfDay);
