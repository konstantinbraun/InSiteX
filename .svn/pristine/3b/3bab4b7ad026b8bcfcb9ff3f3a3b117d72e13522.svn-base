...
{
    public partial class DocumentRules : App.BasePage
    {
        ...
        protected void RadGrid1_ItemUpdated(object sender, GridUpdatedEventArgs e)
        {
            ...
            else
            {
                ...
                id += (e.Item as GridEditFormItem).GetDataKeyValue("RelevantFor").ToString() + "|";
                id += (e.Item as GridEditFormItem).GetDataKeyValue("RelevantDocumentID").ToString();
        ...
        protected void RadGrid1_ItemDeleted(object sender, GridDeletedEventArgs e)
        {
            ...
            else
            {
                ...
                id += (e.Item as GridDataItem).GetDataKeyValue("RelevantFor").ToString() + "|";
                id += (e.Item as GridDataItem).GetDataKeyValue("RelevantDocumentID").ToString();
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                if (e.Item.OwnerTableView.Name.Equals("DocumentRules"))
                {
                    GridDataItem parentItem = e.Item.OwnerTableView.ParentItem;
                    if (parentItem != null)
                    {
                        relevantFor = Convert.ToInt16(parentItem.OwnerTableView.DataKeyValues[parentItem.ItemIndex]["RelevantFor"]);
        ...
        protected void RadGrid1_DetailTableDataBind(object sender, GridDetailTableDataBindEventArgs e)
        {
            ...
            if (e.DetailTableView.ParentItem.DataItem != null)
            {
                Int16 relevantFor = 0;
                string parent = "";
                if (e.DetailTableView.Name != "DocumentRules")
                {
                    ...
                    case "RelevantFor":
                        {
                            if (e.DetailTableView.ParentItem.OwnerTableView.ParentItem.OwnerTableView.ParentItem.DataItem != null)
                            {
                                ...
                                e.DetailTableView.Caption = String.Concat(Resources.Resource.lblEmployerCountryGroup, " ", parent2, "/", Resources.Resource.lblEmployeeCountryGroup, " ", parent1, "/", parent, ": ", Resources.Resource.lblRelevantFor);
                            }
                            break;
                        }
                    case "DocumentRules":
                        {
                            if (e.DetailTableView.ParentItem.OwnerTableView.ParentItem.OwnerTableView.ParentItem.OwnerTableView.ParentItem.DataItem != null)
                            {
                                parent = (String)GetGlobalResourceObject("Resource", (e.DetailTableView.ParentItem.DataItem as DataRowView)["ResourceID"].ToString());
                                string parent1 = (e.DetailTableView.ParentItem.OwnerTableView.ParentItem.DataItem as DataRowView)["NameVisible"].ToString();
                                string parent2 = (e.DetailTableView.ParentItem.OwnerTableView.ParentItem.OwnerTableView.ParentItem.DataItem as DataRowView)["NameVisible"].ToString();
                                string parent3 = (e.DetailTableView.ParentItem.OwnerTableView.ParentItem.OwnerTableView.ParentItem.OwnerTableView.ParentItem.DataItem as DataRowView)["NameVisible"].ToString();
                                e.DetailTableView.Caption = String.Concat(Resources.Resource.lblEmployerCountryGroup, " ", parent3, "/", Resources.Resource.lblEmployeeCountryGroup, " ", parent2, "/", parent1, "/", parent, ": ", Resources.Resource.lblRelevantDocument);
                            }
                            relevantFor = Convert.ToInt16((e.DetailTableView.ParentItem.DataItem as DataRowView)["RelevantFor"]);
                            break;
                        }
                }
            }
        ...
        {
            if (e.Item.OwnerTableView.Name.Equals("RelevantFor"))
            {
            ...
            if (e.Item is GridEditableItem && e.Item.IsInEditMode)
            {
                ...
                tb = (HiddenField)editItem.FindControl("EmploymentStatusID");
                tb.Value = employmentStatusID.ToString();
                tb = (HiddenField)editItem.FindControl("RelevantFor");
                tb.Value = relevantFor.ToString();
            }
        ...
        protected void RadGrid1_ItemCreated(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridEditableItem && e.Item.IsInEditMode)
            {
                RadDropDownList ddl = (e.Item as GridEditableItem)["RelevantDocumentID"].Controls[9] as RadDropDownList;
                // SqlDataSource_RelevantDocuments.SelectParameters["RelevantFor"].DefaultValue = relevantFor.ToString();
                // ddl.SelectedValue = "Bind(\"RelevantDocumentID\")";
                // ddl.DataBind();
            }
        ...
        protected void RadDropDownList1_BindToDataSource(RadDropDownList ddl, Int16 relevantFor)
        {
            SqlConnection con = new SqlConnection(ConnectionString);
            StringBuilder sql = new StringBuilder();
            sql.Append("SELECT * FROM Master_RelevantDocuments ");
            sql.AppendFormat("WHERE (SystemID = {0}) ", Session["SystemID"].ToString());
            sql.AppendFormat("AND (BpID = {0}) ", Session["BpID"].ToString());
            sql.AppendFormat("AND (RelevantFor = {0}) ", relevantFor.ToString());
            ...
            if (ddl != null)
            {
                ddl.DataTextField = "NameVisible";
                ddl.DataValueField = "RelevantDocumentID";
        ...
        protected void RadDropDownList1_ItemDataBound(object sender, DropDownListItemEventArgs e)
        {
            ...
            Int16 relevantRow = Convert.ToInt16(dataSourceRow["RelevantFor"]);
            if (relevantRow != relevantFor)
            {
                e.Item.Remove();
            }
        }

        protected void SqlDataSource_DocumentRules_Deleting(object sender, SqlDataSourceCommandEventArgs e)
        {
            string ret = e.Command.Parameters["@original_RelevantDocumentID"].Value.ToString();
            Helpers.DialogLogger(type, Actions.Delete, ret, Resources.Resource.lblActionDelete);
            Helpers.RelevantDocumentChanged(Convert.ToInt32(ret));
        }

        protected void SqlDataSource_DocumentRules_Inserting(object sender, SqlDataSourceCommandEventArgs e)
        {
            string ret = e.Command.Parameters["@RelevantDocumentID"].Value.ToString();
