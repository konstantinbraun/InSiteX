<%@ Page Title="<%$ Resources:Resource, lblReportTariffData %>" Language="C#" AutoEventWireup="true" CodeBehind="TariffData.aspx.cs" Inherits="InSite.App.Views.Reports.TariffData" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
                <AjaxSettings>
                    <telerik:AjaxSetting AjaxControlID="TariffID">
                        <UpdatedControls>
                    ...
                    <telerik:AjaxSetting AjaxControlID="BpID">
                        <UpdatedControls>
                            <telerik:AjaxUpdatedControl ControlID="PanelTariff" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
                </AjaxSettings>
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" RenderSelectedPageOnly="false">
                ...
                <telerik:RadPageView ID="RadPageView1" runat="server" Selected="true">
                    <table>
                        <tr>
                            <td>
                                <asp:Panel ID="PanelTariff" runat="server" Visible="false">
                                    <fieldset style="border-radius: 5px; border-style: solid; border-color: ActiveBorder; border-width: 1px;">
                                        <legend style="background-color: transparent;">
                                            <b><%= Resources.Resource.lblTariff %></b>
                                        </legend>
                                        <table cellpadding="3px" style="padding: 5px; margin-right: 10px; width: 100%;">
                                            <tr>
                                                <td nowrap="nowrap">
                                                    <asp:Label runat="server" ID="LabelTariff" Text='<%$ Resources:Resource, lblTariff %>'></asp:Label>
                                                </td>
                                                <td colspan="2">
                                                    <telerik:RadComboBox runat="server" ID="TariffID" EmptyMessage="<%$ Resources:Resource, msgPleaseTypeHere %>" OnSelectedIndexChanged="TariffID_SelectedIndexChanged"
                                                                         DataValueField="TariffID" DataTextField="NameVisible" Width="300px" OnClientKeyPressing="OnClientKeyPressing" AutoPostBack="true"
                                                                         Filter="Contains" DropDownAutoWidth="Enabled" DataSourceID="SqlDataSource_Tariffs" OnClientDropDownOpening="AdjustRadWindow"
                                            ...
                                            <tr>
                                                <td nowrap="nowrap">
                                                    <asp:Label runat="server" ID="LabelTariffContracts" Text='<%$ Resources:Resource, lblTariffContract %>'></asp:Label>
                                                </td>
                                                <td colspan="2">
                                                    <telerik:RadComboBox runat="server" ID="TariffContractID" EmptyMessage="<%$ Resources:Resource, msgPleaseTypeHere %>" OnSelectedIndexChanged="TariffContractID_SelectedIndexChanged"
                                                                         DataValueField="TariffContractID" DataTextField="NameVisible" Width="300px" OnClientKeyPressing="OnClientKeyPressing" AutoPostBack="true"
                                                                         Filter="Contains" DropDownAutoWidth="Enabled" DataSourceID="SqlDataSource_TariffContracts" OnClientDropDownOpening="AdjustRadWindow"
                                                                         OnClientDropDownClosing="AdjustRadWindow">
                                                    </telerik:RadComboBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td nowrap="nowrap">
                                                    <asp:Label runat="server" ID="LabelTariffScope" Text='<%$ Resources:Resource, lblTariffScope %>'></asp:Label>
                                                </td>
                                                <td colspan="2">
                                                    <telerik:RadComboBox runat="server" ID="TariffScopeID" EmptyMessage="<%$ Resources:Resource, msgPleaseTypeHere %>"
                                                                         DataValueField="TariffScopeID" DataTextField="NameVisible" Width="300px" OnClientKeyPressing="OnClientKeyPressing"
                                                                         Filter="Contains" DropDownAutoWidth="Enabled" DataSourceID="SqlDataSource_TariffScopes" OnClientDropDownOpening="AdjustRadWindow"
                                                                         OnClientDropDownClosing="AdjustRadWindow">
                                                    </telerik:RadComboBox>
                                                </td>
                                            </tr>
                                ...
                                <table cellpadding="3px" style="padding: 5px; margin-right: 10px; width: 100%;">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="LabelValid" runat="server" Text="<%$ Resources:Resource, lblValid %>"></asp:Label>
                                        </td>
                                        <td style="text-align: left; vertical-align: bottom">
                                            <asp:Label ID="LabelValid1" runat="server" Text="<%$ Resources:Resource, lblBetweenToLower %>"></asp:Label>
                                            <br />
                                            <telerik:RadDatePicker ID="DateTimeFrom" runat="server" MinDate="1900/1/1" MaxDate="2100/1/1" EnableShadows="true"
                                        ...
                                        <td>
                                            <asp:Label ID="LabelValid2" runat="server" Text="<%$ Resources:Resource, lblAndToLower %>"></asp:Label>
                                            <br />
                                            <telerik:RadDatePicker ID="DateTimeUntil" runat="server" MinDate="1900/1/1" MaxDate="2100/1/1" EnableShadows="true"
                                                                   ShowPopupOnFocus="true" >
                                                <ClientEvents OnPopupOpening="AdjustRadWindow" OnPopupClosing="AdjustRadWindow" />
                                                <Calendar runat="server">
                                                    <FastNavigationSettings CancelButtonCaption="<%$ Resources:Resource, lblActionCancel %>" OkButtonCaption="<%$ Resources:Resource, lblOK %>"
            ...
            <table style="width: 100%;">
                ...
                <tr style="float: right;">
                    <td style="text-align: right; float: right;" nowrap="nowrap">
                        <telerik:RadButton runat="server" Text="<%$ Resources:Resource, lblCancel %>" ID="RadButton1" OnClick="BtnCancel_Click" />
            ...
            <asp:SqlDataSource ID="SqlDataSource_TariffScopes" runat="server" ConnectionString="<%$ ConnectionStrings:Insite_Dev_ConnectionString %>"
                               SelectCommand="SELECT * FROM [System_TariffScopes] WHERE SystemID = @SystemID AND TariffID = @TariffID AND TariffContractID = @TariffContractID ORDER BY [NameVisible]" >
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="SystemID" SessionField="SystemID" Type="Int32" />
                    <asp:ControlParameter ControlID="TariffID" PropertyName="SelectedValue" DefaultValue="0" Name="TariffID"></asp:ControlParameter>
                    <asp:ControlParameter ControlID="TariffContractID" PropertyName="SelectedValue" DefaultValue="0" Name="TariffContractID"></asp:ControlParameter>
                </SelectParameters>
            </asp:SqlDataSource>

            <asp:SqlDataSource ID="SqlDataSource_TariffContracts" runat="server" ConnectionString="<%$ ConnectionStrings:Insite_Dev_ConnectionString %>"
            ...
            <asp:SqlDataSource ID="SqlDataSource_Tariffs" runat="server" ConnectionString="<%$ ConnectionStrings:Insite_Dev_ConnectionString %>"
