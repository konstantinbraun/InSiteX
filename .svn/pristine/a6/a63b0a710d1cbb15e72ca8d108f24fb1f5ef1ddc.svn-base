<%@ Page Title="<%$ Resources:Resource, lblReportPresenceCount %>" Language="C#" AutoEventWireup="true" CodeBehind="PresenceCount.aspx.cs" Inherits="InSite.App.Views.Reports.PresenceCount" %>
...
<%--                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadDatePicker ID="DateTimeFrom" runat="server" MinDate="1900/1/1" EnableShadows="true" 
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="DateTimeFrom" ErrorMessage="<%$ Resources:Resource, msgAccessDateRequired %>" Text="*" 
                        ...
                        <tr>
                            <td nowrap="nowrap">
                                <asp:Label runat="server" ID="LabelAccessAreaID" Text='<%$ Resources:Resource, lblAccessArea %>'></asp:Label>
                            </td>
                            <td colspan="2">
                                <telerik:RadComboBox runat="server" ID="AccessAreaID" EmptyMessage="<%$ Resources:Resource, msgPleaseTypeHere %>" DataValueField="AccessAreaID"
                                                     Width="300" OnClientKeyPressing="OnClientKeyPressing" DataSourceID="SqlDataSource_AccessAreas" DataTextField="NameVisible"
                        ...
                        <tr>
                            <td nowrap="nowrap">
                                <asp:Label runat="server" ID="LabelPresentOnly" Text='<%$ Resources:Resource, lblPresentOnly %>'></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:CheckBox runat="server" ID="PresentOnly" />
                            </td>
                        </tr>
                        <tr>
                            <td nowrap="nowrap">
