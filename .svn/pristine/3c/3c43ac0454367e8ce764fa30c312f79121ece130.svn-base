<%@ Page Title="<%$ Resources:Resource, lblReportPassBilling %>" Language="C#" AutoEventWireup="true" CodeBehind="PassBilling.aspx.cs" Inherits="InSite.App.Views.Reports.PassBilling" %>
                ...
                <telerik:RadPageView ID="RadPageView1" runat="server" Selected="true">
                    <div style="border-color: ActiveBorder; border-width: 1px; border-style: none; border-radius: 5px; padding: 5px; margin: 5px;">
                        ...
                        <table cellpadding="3px" style="padding: 5px; margin-right: 10px;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="LabelLastEdit" runat="server" Text="<%$ Resources:Resource, statPrinted %>"></asp:Label>
                                </td>
                                <td style="text-align: left; vertical-align: bottom">
                                    <asp:Label ID="LabelLastEdit1" runat="server" Text="<%$ Resources:Resource, lblBetweenToLower %>"></asp:Label>
                                    <br />
                                    <telerik:RadDateTimePicker ID="DateTimeFrom" runat="server" MinDate="1900/1/1" MaxDate="<%# DateTime.Now %>" EnableShadows="true"
                                ...
                                <td nowrap="nowrap">
                                    <asp:Label ID="LabelLastEdit2" runat="server" Text="<%$ Resources:Resource, lblAndToLower %>"></asp:Label>
                                    <br />
                                    <telerik:RadDateTimePicker ID="DateTimeUntil" runat="server" MinDate="1900/1/1" MaxDate="<%# DateTime.Now %>" EnableShadows="true"
                                                               ShowPopupOnFocus="true" AutoPostBackControl="Calendar" 
                                                               OnSelectedDateChanged="DateTimeUntil_SelectedDateChanged">
                                        <ClientEvents OnPopupOpening="AdjustRadWindow" OnPopupClosing="AdjustRadWindow" />
                                        <Calendar runat="server">
                                            <FastNavigationSettings CancelButtonCaption="<%$ Resources:Resource, lblActionCancel %>" OkButtonCaption="<%$ Resources:Resource, lblOK %>"
                                                                    TodayButtonCaption="<%$ Resources:Resource, lblToday %>">
