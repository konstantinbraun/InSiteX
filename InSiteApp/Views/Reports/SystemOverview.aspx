<%@ Page Title="<%$ Resources:Resource, lblSystemOverview %>" Language="C#" AutoEventWireup="true" CodeBehind="SystemOverview.aspx.cs" Inherits="InSite.App.Views.Reports.SystemOverview" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" CausesValidation="False" OnClientTabSelected="AdjustRadWindow" SelectedIndex="1">
                <Tabs>
                    <telerik:RadTab PageViewID="RadPageView1" ImageUrl="~/Resources/Icons/params_22.png" Text="<%$ Resources:Resource, lblParameters %>" Font-Bold="true" Value="1" />
                    <telerik:RadTab PageViewID="RadPageView2" ImageUrl="~/Resources/Icons/schedule_22.png" Text="<%$ Resources:Resource, lblScheduling %>" Font-Bold="true" Value="2" Selected="True" />
                </Tabs>
            </telerik:RadTabStrip>

            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" RenderSelectedPageOnly="false" SelectedIndex="1">
                ...
                <telerik:RadPageView ID="RadPageView1" runat="server" Selected="true">
                    <div style="border-color: ActiveBorder; border-width: 1px; border-style: none; border-radius: 5px; padding: 5px; margin: 5px;">
                        ...
                        <table cellpadding="3px" style="padding: 5px; margin-right: 10px;">
                            <tr>
                                <td nowrap="nowrap">
                                    <asp:Label runat="server" ID="LabelBp" Text='<%$ Resources:Resource, lblBuildingProject %>'></asp:Label>
                                </td>
                                <td colspan="2">
                                    <telerik:RadComboBox runat="server" ID="BpID" EmptyMessage="<%$ Resources:Resource, msgPleaseTypeHere %>" DataValueField="BpID" DataTextField="NameVisible"
                                                         Width="300" OnClientKeyPressing="OnClientKeyPressing" DataSourceID="SqlDataSource_BuidingProjects" OnSelectedIndexChanged="BpID_SelectedIndexChanged"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="LabelStatisticsDate" runat="server" Text="<%$ Resources:Resource, lblDate %>"></asp:Label>
                                </td>
                                <td style="text-align: left; vertical-align: bottom">
                                    <telerik:RadDatePicker ID="StatisticsDate" runat="server" MinDate="1900/1/1" EnableShadows="true" Width="148px"
            ...
            <asp:SqlDataSource ID="SqlDataSource_BuidingProjects" runat="server" ConnectionString="<%$ ConnectionStrings:Insite_Dev_ConnectionString %>"
                SelectCommand="SELECT m_bp.SystemID, m_bp.BpID, m_bp.NameVisible, m_bp.DescriptionShort FROM Master_BuildingProjects AS m_bp INNER JOIN Master_UserBuildingProjects AS m_ubp ON m_bp.SystemID = m_ubp.SystemID AND m_bp.BpID = m_ubp.BpID WHERE (m_bp.SystemID = @SystemID) AND (m_ubp.UserID = @UserID) AND (m_bp.TypeID = 1) AND (m_bp.IsVisible = 1) ORDER BY m_bp.NameVisible">
        <SelectParameters>
