...
{
    public partial class PresenceCount : BasePagePopUp
    {
        ...
        {
            this.Title = Resources.Resource.lblReportPresenceCount;
            this.AccessAreaID.Focus();
            ...
            if (!IsPostBack)
            {
                ...
                //this.DateTimeFrom.SelectedDate = DateTime.Today;
                //this.DateTimeFrom.MaxDate = DateTime.Today;
        ...
        {
            int accessAreaID = Convert.ToInt32(AccessAreaID.SelectedValue);
            ...
            //if (DateTimeFrom.SelectedDate != null && presenceLevel == 3)
            //{
            //    dateFrom = (DateTime)DateTimeFrom.SelectedDate;
            //}

            bool presentOnly = PresentOnly.Checked;

            int companyLevel = Convert.ToInt32(SelectNodes.SelectedValue);

            Webservices webservice = new Webservices();

            GetPresenceDataNow_Result[] result = webservice.GetPresenceDataNow(companyID, companyLevel, accessAreaID, dateFrom, presentOnly);

            if (result == null || result.Count() == 0)
            {
                Notification1.Title = Resources.Resource.lblReportPresenceCount;
            ...
            else
            {
                ...
                pck.Workbook.Properties.Title = Resources.Resource.lblReportPresenceCount;
                ...
                ws.Cells[1, 1].Value = Resources.Resource.lblReportPresenceCount;
                ...
                ws.Cells[5, 1].Value = Resources.Resource.lblAccessOn + ":";
                //if (DateTimeFrom.SelectedDate != null)
                //{
                //    ws.Cells[5, 2].Value = DateTimeFrom.SelectedDate;
                ...
                ws.Cells[6, 1].Value = Resources.Resource.lblAccessArea + ":";
                if (AccessAreaID.SelectedValue != null && !AccessAreaID.SelectedValue.Equals(string.Empty))
                {
                    ws.Cells[6, 2].Value = AccessAreaID.SelectedItem.Text;
                }

                ws.Cells[7, 1].Value = Resources.Resource.lblCompany + ":";
                if (CompanyID.SelectedValue != null && !CompanyID.SelectedValue.Equals(string.Empty))
                {
                    ws.Cells[7, 2].Value = CompanyID.SelectedText;
                }

                ws.Cells[8, 1].Value = Resources.Resource.lblPresentOnly + ":";
                if (PresentOnly.Checked)
                {
                    ws.Cells[8, 2].Value = Resources.Resource.lblYes;
                }
                else
                {
                    ws.Cells[8, 2].Value = Resources.Resource.lblNo;
                }

                ws.Cells[9, 1].Value = Resources.Resource.lblConsideredLevels + ":";
                ws.Cells[9, 2].Value = SelectNodes.SelectedItem.Text;

                ws.Cells[10, 1].Value = Resources.Resource.lblTemplate + ":";
                ws.Cells[10, 2].Value = TemplateID.SelectedItem.Text;

                ws.Cells[11, 1].Value = Resources.Resource.lblRemarks + ":";
                ws.Cells[11, 2].Value = Remarks.Text;
                ws.Cells[11, 2].Style.WrapText = true;

                ws.Cells[12, 1].Value = Resources.Resource.lblState + ":";
                ws.Cells[12, 2].Value = DateTime.Now.ToString("ddd, dd.MM.yyyy HH:mm");

                ws.Cells[13, 1].Value = Resources.Resource.lblUser + ":";
                ws.Cells[13, 2].Value = Session["LoginName"].ToString();

                ExcelRange parameters = ws.Cells[1, 1, 13, 2];
                ...
                ws.Cells[1, 2].Value = Resources.Resource.lblAccessArea;
                ws.Cells[1, 3].Value = Resources.Resource.lblTrade + Resources.Resource.lblID;
                ws.Cells[1, 4].Value = Resources.Resource.lblTrade;
                ws.Cells[1, 5].Value = Resources.Resource.lblEmployeeID;
                ws.Cells[1, 6].Value = Resources.Resource.lblLastName;
                ws.Cells[1, 7].Value = Resources.Resource.lblFirstName;
                ws.Cells[1, 8].Value = Resources.Resource.lblEmploymentStatus;
                ws.Cells[1, 9].Value = Resources.Resource.lblEntrance;
                ws.Cells[1, 10].Value = Resources.Resource.lblLeaving;
                ws.Cells[1, 11].Value = Resources.Resource.lblIsPresent1;
                ws.Cells[1, 12].Value = Resources.Resource.lblIndex;
                ws.Cells[1, 13].Value = Resources.Resource.lblIndentLevel;
                ws.Cells[1, 14].Value = Resources.Resource.lblType;
                ws.Cells[1, 15].Value = Resources.Resource.lblIsFirstAider;

                // Daten
                int rowNum = 1;
                foreach (GetPresenceDataNow_Result row in result)
                {
                    rowNum++;

                    ws.Cells[rowNum, 1].Value = row.CompanyName;
                    ws.Cells[rowNum, 2].Value = row.AccessAreaName;
                    ws.Cells[rowNum, 3].Value = row.TradeNumber;
                    ws.Cells[rowNum, 4].Value = row.TradeName;
                    ws.Cells[rowNum, 5].Value = row.EmployeeID;
                    ws.Cells[rowNum, 6].Value = row.LastName;
                    ws.Cells[rowNum, 7].Value = row.FirstName;
                    ws.Cells[rowNum, 8].Value = row.EmploymentStatusName;

                    // Kommen
                    ws.Cells[rowNum, 9].Value = row.AccessAt;
                    ws.Cells[rowNum, 9].Style.Numberformat.Format = "DD.MM.YYYY hh:mm";
                    ws.Cells[rowNum, 9].Style.HorizontalAlignment = OfficeOpenXml.Style.ExcelHorizontalAlignment.Left;

                    // Gehen
                    ws.Cells[rowNum, 10].Value = row.ExitAt;
                    ws.Cells[rowNum, 10].Style.Numberformat.Format = "DD.MM.YYYY hh:mm";
                    ws.Cells[rowNum, 10].Style.HorizontalAlignment = OfficeOpenXml.Style.ExcelHorizontalAlignment.Left;

                    ws.Cells[rowNum, 11].Value = row.IsPresent;
                    ws.Cells[rowNum, 12].Value = row.TreeLevel;
                    ws.Cells[rowNum, 13].Value = row.IndentLevel;
                    ws.Cells[rowNum, 14].Value = row.PassType;
                    ws.Cells[rowNum, 15].Value = row.IsFirstAider;
                }
                ...
                Response.AddHeader("content-disposition", "attachment;  filename=" + Helpers.CleanFilename(Resources.Resource.lblReportPresenceCount + "_" + fileDate + "." + suffix));
            ...
            int companyLevel)
        {
            ...
            xeReportParameters.Add(new XElement("Parameter", dateFrom, new XAttribute("Name", "PresenceDay")));
            ...
            xeReportParameters.Add(new XElement("Parameter", presentOnly, new XAttribute("Name", "PresentOnly")));
            xeReportParameters.Add(new XElement("Parameter", companyLevel, new XAttribute("Name", "CompanyLevel")));
            ...
            string remarks)
        {
            ...
            job.NameVisible = Resources.Resource.lblReportPresenceCount;
        ...
        protected void OK_Click(object sender, EventArgs e)
        {
            ...
            string accessAreaName = Resources.Resource.lblAll;
            if (!AccessAreaID.SelectedItem.Text.Equals(string.Empty))
            {
                accessAreaName = AccessAreaID.SelectedItem.Text;
            }
            ...
            if (!TemplateID.SelectedValue.Equals(string.Empty))
            {
                ...
                if (ExecutionInterval.SelectedValue.Equals("0") && diff < 5)
                {
                    ...
                    if (report != null && report.FileData != null && report.DocumentID == 0)
                    {
                        ...
                        string fileDate = DateTime.Now.ToString("yyyyMMddHHmm");
                        Response.AddHeader("content-disposition", "attachment;  filename=" + Helpers.CleanFilename(Resources.Resource.lblReportPresenceCount + "_" + fileDate + "." + report.FileExtension));
