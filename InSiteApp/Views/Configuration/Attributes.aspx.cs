...
{
    public partial class Attributes : App.BasePage
    {
        ...
        private static string idName = "AttributeID";
        ...
        public void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item != null && e.Item.OwnerTableView.Name.Equals("Attributes"))
            {
                    ...
                    case RadGrid.UpdateCommandName:
                        {
                            ...
                            SqlDataSource_AttributesBuildingProject.UpdateParameters["PassColor"].DefaultValue = ColorTranslator.ToHtml(((RadColorPicker)editedItem.FindControl("RadColorPicker1")).SelectedColor);
                            break;
                        }
                    case RadGrid.PerformInsertCommandName:
                        {
                            GridEditableItem insertItem = (GridEditableItem)e.Item;
                            SqlDataSource_AttributesBuildingProject.InsertParameters["PassColor"].DefaultValue = ColorTranslator.ToHtml(((RadColorPicker)insertItem.FindControl("RadColorPicker1")).SelectedColor);
                            break;
                        }
                }
            }
