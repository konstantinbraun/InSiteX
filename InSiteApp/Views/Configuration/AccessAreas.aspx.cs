...
{
    public partial class AccessAreas : App.BasePage
    {
        ...
        private static string idName = "AccessAreaID";
        ...
        protected void PresentTimeHours_TextChanged(object sender, EventArgs e)
        {
        ...
        protected void PresentTimeMinutes_TextChanged(object sender, EventArgs e)
        {
            RadNumericTextBox tb = (sender as RadNumericTextBox);
            RadSlider slider = (RadSlider)tb.Parent.Controls[3];
            decimal sliderValue = 0;
