<%@ Page Title="<%$ Resources:Resource, lblBuildingProjectTrades %>" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TradeGroups.aspx.cs" Inherits="InSite.App.Views.Configuration.TradeGroups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div>
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" DataSourceID="SqlDataSource_TradeGroups" GridLines="None" CssClass="MainGrid" AllowAutomaticDeletes="True"
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="SystemID,BpID,TradeGroupID" CommandItemDisplay="Top" EditMode="PopUp" DataSourceID="SqlDataSource_TradeGroups"
                    ...
                    <asp:Panel runat="server" ID="InnerContainer1" Visible="true">
                        ...
                        <telerik:RadMultiPage runat="server" ID="Multipage1" SelectedIndex="0" RenderSelectedPageOnly="false">
                            ...
                            <telerik:RadPageView runat="server" ID="PageView1_1">
                                ...
                                <%-- Trades Grid --%>
                                <telerik:RadGrid ID="RadGridTrades" EnableHierarchyExpandAll="true" DataSourceID="SqlDataSource_Trades" Width="100%" AllowAutomaticInserts="true" AllowSorting="true"
                                                 ...
                                                 OnItemInserted="RadGrid1_ItemInserted" OnPreRender="RadGrid1_PreRender" OnItemCreated="RadGridTrades_ItemCreated" OnItemDataBound="RadGridTrades_ItemDataBound"
                                    ...
                                    <MasterTableView Name="Trades" DataSourceID="SqlDataSource_Trades" HierarchyLoadMode="ServerOnDemand" EnableHierarchyExpandAll="true"
                                                     ...
                                                     DataKeyNames="SystemID,BpID,TradeGroupID,TradeID"
                                ...
                                <asp:SqlDataSource ID="SqlDataSource_Trades" runat="server" ConnectionString="<%$ ConnectionStrings:Insite_Dev_ConnectionString %>" OnInserted="SqlDataSource_Inserted"
                                                   ...
                                                   DeleteCommand="INSERT INTO History_Trades SELECT * FROM Master_Trades WHERE [SystemID] = @original_SystemID AND [BpID] = @original_BpID AND (TradeGroupID = @original_TradeGroupID) AND (TradeID = @original_TradeID); 
                                                   DELETE FROM Master_Trades WHERE (SystemID = @original_SystemID) AND (BpID = @original_BpID) AND (TradeGroupID = @original_TradeGroupID) AND (TradeID = @original_TradeID)"
                                                   InsertCommand="INSERT INTO Master_Trades(SystemID, BpID, TradeGroupID, NameVisible, DescriptionShort, TradeNumber, CostLocationID, CreatedFrom, CreatedOn, EditFrom, EditOn) VALUES (@SystemID, @BpID, @TradeGroupID, @NameVisible, @DescriptionShort, @TradeNumber, @CostLocationID, @UserName, SYSDATETIME(), @UserName, SYSDATETIME()) 
                                                   SELECT @ReturnValue = SCOPE_IDENTITY()"
                                                   SelectCommand="SELECT * FROM Master_Trades WHERE (SystemID = @SystemID) AND (BpID = @BpID) AND (TradeGroupID = @TradeGroupID) ORDER BY TradeNumber"
                                                   UpdateCommand="INSERT INTO History_Trades SELECT * FROM Master_Trades WHERE [SystemID] = @original_SystemID AND [BpID] = @original_BpID AND (TradeGroupID = @original_TradeGroupID) AND (TradeID = @original_TradeID); 
                                                   UPDATE Master_Trades SET NameVisible = @NameVisible, DescriptionShort = @DescriptionShort, TradeNumber = @TradeNumber, CostLocationID = @CostLocationID, EditFrom = @UserName, EditOn = SYSDATETIME() WHERE (SystemID = @original_SystemID) AND (BpID = @original_BpID) AND (TradeGroupID = @original_TradeGroupID) AND (TradeID = @original_TradeID)">
                                    <DeleteParameters>
                                    ...
                                    <InsertParameters>
                                        ...
                                        <asp:Parameter DefaultValue="0" Name="CostLocationID" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadComboBox ID="RadComboBoxTemplateID" DataSourceID="SqlDataSource_Templates" DataTextField="NameVisible"
                                                    ...
                                                    <Items>
                                                        <telerik:RadComboBoxItem Text="<%$ Resources:Resource, lblAll %>" Value="0" />
                                                    </Items>
                                                </telerik:RadComboBox>
                                            </td>
                                        </tr>
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn DataField="PassColor" FilterControlAltText="Filter PassColor column" HeaderText="<%$ Resources:Resource, lblPassColor %>"
                        ...
                        <EditItemTemplate>
                            <telerik:RadColorPicker ID="RadColorPicker1" runat="server" EnableTheming="true" ShowRecentColors="true" ShowIcon="true"
                                                    SelectedColor='<%# InSite.App.Helpers.Html2Color(InSite.App.Helpers.CStr(Eval("PassColor"))) %>' PaletteModes="All" ShowEmptyColor="true" Width="300px">
    ...
    <asp:SqlDataSource ID="SqlDataSource_TradeGroups" runat="server" ConnectionString="<%$ ConnectionStrings:Insite_Dev_ConnectionString %>" OnInserted="SqlDataSource_Inserted"
                       OldValuesParameterFormatString="original_{0}"
                       DeleteCommand="INSERT INTO History_Trades SELECT * FROM Master_Trades WHERE [SystemID] = @original_SystemID AND [BpID] = @original_BpID AND (TradeGroupID = @original_TradeGroupID); 
                       INSERT INTO History_TradeGroups SELECT * FROM Master_TradeGroups WHERE [SystemID] = @original_SystemID AND [BpID] = @original_BpID AND (TradeGroupID = @original_TradeGroupID); 
                       DELETE FROM Master_TradeGroups WHERE (SystemID = @original_SystemID) AND (BpID = @original_BpID) AND (TradeGroupID = @original_TradeGroupID); 
                       DELETE FROM Master_Trades WHERE (SystemID = @original_SystemID) AND (BpID = @original_BpID) AND (TradeGroupID = @original_TradeGroupID) "
                       InsertCommand="INSERT INTO Master_TradeGroups(SystemID, BpID, NameVisible, DescriptionShort, Position, PassColor, TemplateID, CreatedFrom, CreatedOn, EditFrom, EditOn) VALUES (@SystemID, @BpID, @NameVisible, @DescriptionShort, @Position, @PassColor, @TemplateID, @UserName, SYSDATETIME(), @UserName, SYSDATETIME()) 
                       SELECT @ReturnValue = SCOPE_IDENTITY()"
                       SelectCommand="SELECT * FROM Master_TradeGroups WHERE (SystemID = @SystemID) AND (BpID = @BpID) ORDER BY Position"
                       UpdateCommand="INSERT INTO History_TradeGroups SELECT * FROM Master_TradeGroups WHERE [SystemID] = @original_SystemID AND [BpID] = @original_BpID AND (TradeGroupID = @original_TradeGroupID); 
                       UPDATE Master_TradeGroups SET NameVisible = @NameVisible, DescriptionShort = @DescriptionShort, Position = @Position, PassColor = @PassColor, TemplateID = @TemplateID, EditFrom = @UserName, EditOn = SYSDATETIME() WHERE (SystemID = @original_SystemID) AND (BpID = @original_BpID) AND (TradeGroupID = @original_TradeGroupID)">
        <DeleteParameters>
