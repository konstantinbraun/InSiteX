...
{
    public partial class ShortTermPassTypes : App.BasePage
    {
        ...
        private static string idName = "ShortTermPassTypeID";
        ...
        protected void RadSlider1_ValueChanged(object sender, EventArgs e)
        {
            ...
            RadNumericTextBox tb = (RadNumericTextBox)slider.Parent.Controls[1];
        ...
        protected void RadSlider3_ValueChanged(object sender, EventArgs e)
        {
            RadSlider slider = (sender as RadSlider);
            RadNumericTextBox tb = (RadNumericTextBox)slider.Parent.Controls[1];
            tb.Text = slider.Value.ToString();
        ...
        protected void ValidDays_TextChanged(object sender, EventArgs e)
        {
            RadNumericTextBox tb = (sender as RadNumericTextBox);
            RadSlider slider = (RadSlider)tb.Parent.Controls[3];
            decimal sliderValue = 0;
            if (tb.Text != null)
            {
                sliderValue = Convert.ToDecimal(tb.Text);
            }
            slider.Value = sliderValue;
        }

        protected void ValidHours_TextChanged(object sender, EventArgs e)
        {
            RadNumericTextBox tb = (sender as RadNumericTextBox);
            RadSlider slider = (RadSlider)tb.Parent.Controls[3];
            decimal sliderValue = 0;
        ...
        protected void ValidMinutes_TextChanged(object sender, EventArgs e)
        {
            RadNumericTextBox tb = (sender as RadNumericTextBox);
            RadSlider slider = (RadSlider)tb.Parent.Controls[3];
            decimal sliderValue = 0;
        ...
        public string GetValidFrom(int value)
        {
            if (value == 1)
            {
                return Resources.Resource.selSTPIssueDate;
            }
            else if (value == 2)
            {
                return Resources.Resource.selSTPVisitorAssign;
            }
            else
                return string.Empty;
        }
        ...
        protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridEditFormInsertItem)
            {
                ...
                RadNumericTextBox tb = item.FindControl("ValidDays") as RadNumericTextBox;
                if (tb != null)
                {
                    tb.Text = "0";
                }
                tb = item.FindControl("ValidHours") as RadNumericTextBox;
                if (tb != null)
                {
                    tb.Text = "0";
                }
                tb = item.FindControl("ValidMinutes") as RadNumericTextBox;
                if (tb != null)
                {
                    tb.Text = "0";
                }
