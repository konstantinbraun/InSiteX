CREATE TABLE [dbo].[Master_TariffData]
(
    [SystemID]         INT            NOT NULL,
    [BpID]             INT            NOT NULL,
    [TariffContractID]           INT            NOT NULL,
    [TariffDataID]           INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_Master_TariffData] PRIMARY KEY ([SystemID], [BpID], [TariffContractID], [TariffDataID]), 
)
