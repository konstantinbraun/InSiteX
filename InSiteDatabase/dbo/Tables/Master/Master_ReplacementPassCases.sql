CREATE TABLE [dbo].[Master_ReplacementPassCases]
(
    [SystemID]         INT            NOT NULL,
    [BpID]             INT            NOT NULL,
    [ReplacementPassCaseID]           INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_Master_ReplacementPassCases] PRIMARY KEY ([SystemID], [BpID], [ReplacementPassCaseID]), 
)
